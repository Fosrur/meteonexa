...
<main class="diag-shell" id="diag-app" hidden>
  ...
  <div class="diag-dashboard">
    <section class="diag-services" aria-labelledby="diag-services-title">
      ...
      <article class="diag-service-card">
        <span class="diag-service-icon" aria-hidden="true">∑</span>
        <div class="diag-service-copy"><span class="diag-label" data-i18n-key="diag.metrics.kicker"></span><h3 data-i18n-key="diag.metrics.title"></h3><p data-i18n-key="diag.metrics.copy"></p></div>
        <button class="diag-button" type="button" data-diag-action="metrics"><span data-i18n-key="diag.metrics.button"></span></button>
      </article>

      <article class="diag-service-card">
        <span class="diag-service-icon" aria-hidden="true">◎</span>
        <div class="diag-service-copy"><span class="diag-label" data-i18n-key="diag.analytics.kicker"></span><h3 data-i18n-key="diag.analytics.title"></h3><p data-i18n-key="diag.analytics.copy"></p></div>
        <button class="diag-button" type="button" data-diag-action="analytics"><span data-i18n-key="diag.analytics.button"></span></button>
      </article>
...
<script defer src="../dist/security-runtime.b4dbf8677d9d.js"></script>
<script defer src="../dist/i18n-runtime.8c5df08eb812.js"></script>
<script defer src="../dist/diagnostics/diagnostics.a25b62189a8a.js"></script>
</body>
</html>
