...
(() => {
    ...
    // Assistant UI is app-level and can be repainted/replaced during bootstrap.
    // Keep every interaction on stable document-level delegation instead of
    // binding individual nodes inside suite.bind(). This is especially important
    // for guest mode, where the dialog can be opened before suite.bind() runs.
    ...
    async function refreshAdvanced(force = false) {
        ...
        // js/advanced.js delegates to this engine and the lifecycle extension also
