...
export const dependencies = Object.freeze(['advanced', 'metrics', 'radar', 'security']);
            ...
            function create(deps) {
                ...
                function radarVectorTileTemplate(frame) {
                    ...
                    const params = new URLSearchParams({
                        path: frame.path, z: '{z}', x: '{x}', y: '{y}', color: String(frame.tileColor ?? 2), smooth: String(frame.tileSmooth || '1_1'),
