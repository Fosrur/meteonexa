...
export const dependencies = Object.freeze(['ai', 'auth', 'copilot', 'guestAccess', 'intelligence', 'metrics', 'security']);
    ...
    provided.suiteAssistant = Object.freeze({
        create(context) {
            ...
            async function askAssistant(question) {
                ...
                if (suite.assistantMode === 'ai') {
                    await answerWithAi(value);
                    return;
                }
                if (!assistantCanAnswerLocally(value)) {
