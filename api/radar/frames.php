...
try {
    ...
    $past = array_map(static function(array $frame) use ($config, $device, $expires, $zoom, $color, $smooth, $centerX, $centerY, $scale): array {
        ...
        $frame['frameSignature'] = meteonexa_sign_resource($config, 'radar-frame-v1', $device . '|' . $path, $expires);
        $frame['tileZoom'] = $zoom;
