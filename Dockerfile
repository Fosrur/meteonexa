...
COPY --from=frontend-build /src/.htaccess /src/index.html /src/privacy.html /src/cookie-policy.html /src/offline.html /src/error.php /src/vendor-asset.php \
     /src/asset-manifest.js /src/asset-manifest.json /src/sw.js /src/robots.txt /src/sitemap.xml /src/favicon.ico /var/www/html/
