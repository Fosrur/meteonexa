...
export const dependencies = Object.freeze(['advanced', 'intelligence', 'metrics', 'suite', 'core']);
...
export function install(services, host = globalThis) {
    return services.installModule({
        ...
        (() => {
            ...
            // controller is created later by app.js. Keeping these objects stable lets the
            // controller hydrate them after app.js loads without breaking the ESM bootstrap.
            ...
            const createController = deps => {
                ...
                function applyUiVisibility() {
                    ...
                    // Keeping it here (in addition to privacy-context.js) prevents first-paint
                ...
                async function goToPage(page, options = {}) {
                    ...
                    const perform = async () => {
                        ...
                        if (pageChanged || options.metricEntry === true) {
                            ...
                            if (metric) deps.metrics?.track?.(metric);
                        }
