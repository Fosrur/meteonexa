...
function scheduleDeferredStyles() {
    const run = () => {
        ...
        appendStylesheet(new URL('vendor-asset.php?asset=maplibre-css', appRoot).href, 'maplibre-css');
    };
