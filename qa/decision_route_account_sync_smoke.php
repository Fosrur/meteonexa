...
$suite=file_get_contents($root.'/suite.js');$app=file_get_contents($root.'/app.js')."\n".file_get_contents($root.'/modules/esm/domains/account.mjs');$intel=file_get_contents($root.'/weather-intelligence.js');
