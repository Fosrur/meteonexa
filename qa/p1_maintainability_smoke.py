...
app=read('app.js'); store=read('modules/esm/core/store.mjs'); readme=read('METEONEXA-20.1-RC2.md'); dbfacade=read('api/database.php'); connection=read('api/database/connection.php'); migrations=read('api/database/migrations.php'); i18n=read('modules/esm/core/i18n-preferences.mjs'); account=read('modules/esm/domains/account.mjs'); authflow=read('modules/esm/domains/auth-flow.mjs'); radarmotion=read('modules/esm/domains/radar-motion.mjs'); radarcontroller=read('modules/esm/domains/radar-controller.mjs'); locations=read('modules/esm/domains/locations.mjs'); navigation=read('modules/esm/domains/navigation.mjs'); notifications=read('modules/esm/domains/notifications.mjs')
