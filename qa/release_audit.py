...
for k in ['ai.system.tool_orchestration','privacy.release.current','cookie.release.current','privacy.ai.orchestration','copilot.evidence.title','privacy.analytics.copy','cookie.analytics.copy']:
...
ck('# MeteoNexa Architecture — 20.1' in (root/'METEONEXA-20.1-RC2.md').read_text(),'Architecture current')
ck('# MeteoNexa Security — 20.1' in (root/'METEONEXA-20.1-RC2.md').read_text(),'Security current')
...
# Core files
for rel in ['analytics.js','api/analytics/config.php','api/ai/orchestrator.php','api/route/weather_engine.php','api/intelligence/decision_timeline_helpers.php','api/intelligence/probabilistic_nowcast_helpers.php','api/plans/watch_engine.php','product-metrics.js']:
