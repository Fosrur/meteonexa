...
errors=[]
browser_files=['app.js','advanced.js','suite.js','config.js','modules/esm/features/intelligence.mjs','modules/esm/core/i18n-preferences.mjs','modules/esm/domains/visualization.mjs','modules/esm/domains/forecast-history.mjs','modules/esm/domains/model-intelligence.mjs','modules/esm/domains/device-sessions.mjs','modules/esm/domains/app-lifecycle.mjs','modules/esm/domains/suite-support.mjs','modules/esm/domains/app-utilities.mjs','modules/esm/domains/suite-assistant.mjs','modules/esm/domains/suite-integrations.mjs','modules/esm/domains/account.mjs','modules/esm/domains/auth-flow.mjs','modules/esm/domains/locations.mjs','modules/esm/domains/navigation.mjs','modules/esm/domains/notifications.mjs','modules/esm/domains/radar-motion.mjs','modules/esm/domains/radar-controller.mjs']
...
for path in [root/'app.js',root/'advanced.js',root/'suite.js',root/'modules/esm/features/intelligence.mjs',root/'api/weather/severe.php',root/'api/intelligence/severe_outlook_helpers.php']:
...
for path in root.rglob('*'):
    if not path.is_file() or 'dist' in path.parts or 'vendor' in path.parts or 'qa' in path.parts or path.name in {'METEONEXA-20.1-RC2.md','.env.example'}: continue
