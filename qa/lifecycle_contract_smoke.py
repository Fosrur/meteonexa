...
advanced=read('js/advanced.js'); suite=read('js/suite.js'); integ=read('modules/esm/domains/suite-integrations.mjs')
nav=read('modules/esm/domains/navigation.mjs'); loc=read('modules/esm/domains/locations.mjs'); radar=read('modules/esm/domains/radar-controller.mjs'); app=read('js/app.js'); css=read('styles/suite/40-ui-regression-fixes.css')
checks={
