...
def main():
    ...
    check('error.php?code=403',403,lambda b,c: b'error-card' in b and b'403' in b,'branded 403 renderer','text/html')
    check('error.php?code=404',404,lambda b,c: b'error-card' in b and b'404' in b,'branded 404 renderer','text/html')
