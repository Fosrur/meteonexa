...
errors=[]
for key in ['cookie.updated','cookie.intel.features','cookie.verified_precision.copy','smart.panel.kicker','privacy.forecast_fusion','privacy.analytics.copy','privacy.analytics.optout','cookie.analytics.copy','cookie.analytics.preference']:
    for loc in locales:
