...
errors=[]
ALLOW_TEXT={'MeteoNexa','MeteoNexa 20.1','Meteo','Nexa','v20.1','meteonexa.com','www.meteonexa.com','km/h','°C','km','--','—','×','•','·'}
...
for rel in ['index.html','privacy.html','cookie-policy.html','offline.html','maintenance.html']:
    parser=VisibleTextAudit(rel); parser.feed((ROOT/rel).read_text(encoding='utf-8'))

ui_files=[ROOT/'js/app.js',ROOT/'js/advanced.js',ROOT/'js/suite.js',ROOT/'js/maintenance.js',*sorted((ROOT/'modules/esm').rglob('*.mjs'))]
patterns=[
...
for path in [*ui_files, ROOT/'privacy.html',ROOT/'cookie-policy.html',ROOT/'offline.html',ROOT/'maintenance.html',ROOT/'index.html']:
    src=path.read_text(encoding='utf-8')
