...
app=read('js/app.js'); advanced=read('js/advanced.js'); suite=read('js/suite.js'); intelligence_shell=read('js/weather-intelligence.js')
...
readme=read('readme.md'); architecture=read('readme.md'); index=read('index.html'); sw=read('js/sw.js'); htaccess=read('.htaccess')
...
classic_registry_consumers=['js/app.js','js/advanced.js','js/suite.js','js/weather-intelligence.js','js/custom-controls.js']
checks={
    ...
    'service worker cache revision final': "const SHELL_REVISION = '20.1-final-04-assistant-runtime-radar';" in sw,
