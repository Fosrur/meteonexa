...
ck("const APP_BUILD = '20.1'" in (root/'js/app.js').read_text(),'app build is 20.1')
ck("const BUILD = '20.1'" in (root/'js/sw.js').read_text(),'service worker build is 20.1')
ck("const VERSION = '20.1'" in (root/'js/i18n-runtime.js').read_text(),'i18n runtime is 20.1')
