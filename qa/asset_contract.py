...
for logical in ['app.js','suite.js','product-metrics.js','analytics.js','copilot.css','modules/esm/features/copilot.mjs','modules/esm/features/route-weather.mjs','modules/esm/features/decision-timeline.mjs','modules/esm/features/watch-plan.mjs','modules/esm/bootstrap.mjs','modules/esm/core/service-registry.mjs','modules/esm/core/runtime-api.mjs','modules/esm/core/store.mjs','modules/esm/core/runtime-state.mjs','modules/esm/core/tooltips.mjs','modules/esm/core/weather-utils.mjs','modules/esm/core/i18n-preferences.mjs']:
...
bootstrap=(root/'modules/esm/bootstrap.mjs').read_text()
deferred_css=['suite.css','intelligence.css','decision-timeline.css','watch-plan.css','copilot.css']
...
for logical in ['modules/esm/domains/navigation.mjs','modules/esm/domains/weather.mjs','modules/esm/features/route-weather.mjs','custom-controls.js','product-metrics.js','analytics.js','app.js','suite.js','modules/esm/features/copilot.mjs']:
...
ck("const APP_BUILD = '20.1'" in (root/'app.js').read_text(),'app build is 20.1')
ck("const BUILD = '20.1'" in (root/'sw.js').read_text(),'service worker build is 20.1')
ck("const VERSION = '20.1'" in (root/'i18n-runtime.js').read_text(),'i18n runtime is 20.1')
