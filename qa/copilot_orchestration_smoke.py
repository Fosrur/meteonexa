...
orch=t('api/ai/orchestrator.php'); chat=t('api/ai/chat.php'); route=t('api/route/weather_engine.php'); endpoint=t('api/route/weather.php'); suite=t('suite.js'); suite_assistant=t('modules/esm/domains/suite-assistant.mjs'); suite_support=t('modules/esm/domains/suite-support.mjs'); cop=t('modules/esm/features/copilot.mjs'); css=t('copilot.css'); html=t('index.html')
