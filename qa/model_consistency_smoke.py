...
app=(root/'app.js').read_text();suite=(root/'suite.js').read_text();fusion=(root/'api/weather/fusion.php').read_text();quality=(root/'api/intelligence/quality_helpers.php').read_text();summary=(root/'api/intelligence/summary.php').read_text()
