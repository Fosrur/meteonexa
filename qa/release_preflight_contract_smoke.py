...
checks={
 ...
 'worker HTTP cron secrets and VAPID subject are optional':all(('optional '+x) in script for x in ['METEONEXA_PIPELINE_CRON_SECRET','METEONEXA_PUSH_CRON_SECRET','METEONEXA_VAPID_SUBJECT']),
