...
req=read('api/auth/request-code.php'); verify=read('api/auth/verify-code.php'); auth=read('api/auth_session.php'); devices=read('api/auth/devices.php'); logout=read('api/auth/logout.php'); status=read('api/auth/status.php'); smtp=read('api/SmtpMailer.php'); bug=read('api/feedback/bug-report.php'); worker=read('api/pipeline/worker.php'); push=read('api/push/dispatch.php'); notifications=read('modules/esm/domains/notifications.mjs'); app=read('js/app.js'); config=read('api/config.php')
checks={
