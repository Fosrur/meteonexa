...
app=(ROOT/'js/app.js').read_text(encoding='utf-8'); suite=(ROOT/'js/suite.js').read_text(encoding='utf-8'); suite_assistant=(ROOT/'modules/esm/domains/suite-assistant.mjs').read_text(encoding='utf-8'); chat=(ROOT/'api/ai/chat.php').read_text(encoding='utf-8'); engine=(ROOT/'api/intelligence/engine_helpers.php').read_text(encoding='utf-8'); html=(ROOT/'index.html').read_text(encoding='utf-8')
checks += [
