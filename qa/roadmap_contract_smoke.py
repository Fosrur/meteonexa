...
html=t('index.html'); app=t('app.js'); advanced=t('advanced.js'); suite=t('suite.js')
quality=t('api/intelligence/quality_helpers.php'); radar=t('qa/radar3_production_gate_smoke.php')
metrics=t('qa/product_metrics_smoke.py'); decision=t('api/intelligence/decision_timeline_helpers.php')
prob=t('api/intelligence/probabilistic_nowcast_helpers.php'); accuracy=t('api/accuracy/public.php')
watch=t('api/plans/watch_engine.php'); intel=t('weather-intelligence.js'); cop=t('api/ai/orchestrator.php'); route=t('api/route/weather_engine.php')
...
# Product metrics
ck('page_home' in metrics and 'use_ai' in metrics and "credentials: 'omit'" in metrics,'privacy-first Product Metrics contract remains')
